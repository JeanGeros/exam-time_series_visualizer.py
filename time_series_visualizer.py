...
# Filtramos los valores que están en el 2.5% más bajo y el 2.5% más alto
lower_values = df[df['value'] <= lower_percentile]
upper_values = df[df['value'] >= upper_percentile]
